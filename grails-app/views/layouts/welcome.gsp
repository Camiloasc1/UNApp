...
<%@ page import="unapp.LoginController" contentType="text/html;charset=UTF-8" %>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="${request.contextPath}/welcome-index/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
